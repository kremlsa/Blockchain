...
MessageGenerator generator = new MessageGenerator(menu);

//menu.run();

new Thread(generator).start();

        menu.generateChainMT(10);
...
public String[] multiThreading(String forhash) {
        ...
        //public void multiThreading(String forhash) {
